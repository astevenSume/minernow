...
func main() {
	transaction, err := CreateTransaction("5JPzYaNNyrUKTo7pZ5rMH1grWHkhSYSD6ieyXPuXGtSKbMZSD2S", "1DXDso8dNotaWxKu9MDt48ZNNgqgxJ1ggC", 546, "b2d44a507bba695451f166e51d87bb769b3ec7ec1f829d52032979e6be022f7d")
	if err != nil {
		fmt.Println(err)
		return
	}
